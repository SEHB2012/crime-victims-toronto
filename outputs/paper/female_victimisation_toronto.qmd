...
finalcrimedata_data <- 
  read_csv(file = "/cloud/project/inputs/data/final_crimedata_toronto.csv",
...
finalcrimedata_data <- 
  read_csv(file = "/cloud/project/inputs/data/data_groupsbycrime.csv",
           show_col_types = FALSE)
head(finalcrimedata_data) |>
kable(
...
finalage_data <- 
  read_csv(file = "/cloud/project/inputs/data/data_groupsbyage.csv",
           show_col_types = FALSE)
head(finalage_data) |>
kable(
